...
<head>
    ...
    <style>
        .container {
            padding: 100px;
            width: 100%;
            font-family: 'Times New Roman', Times, serif;/*Poner el tipo de letra*/

            
    height: 600px;
    background: linear-gradient(to right, #fdeff994, #ec38bc96, #7403c0a2, #03001ea1);  /* Sirve para poner el degradado del color en la pagina principalmente en la cabecera*/
        ...
        .cart-link {
            ...
            display: block;
            font-size: 22px;
            background: linear-gradient(to right, #fdeff994, #ec38bc96, #7403c0a2, #03001ea1)
text-align: right;/*Sirve para alinear el texto*/
